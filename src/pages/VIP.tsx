    ...
    <div className="min-h-screen flex items-center justify-center bg-black p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-white/10 backdrop-blur-md p-8 border border-white/20 rounded-lg shadow-xl relative z-10">
        <div className="mb-8 text-center">
          ...
          <p className="text-gray-200 text-sm mt-2">Sign in to access exclusive VIP content</p>
        </div>
        ...
        <form className="space-y-5" onSubmit={handleEmailSignIn}>
          ...
          <div className="flex items-center space-x-2">
            ...
            <label 
              htmlFor="remember" 
              className="text-sm text-gray-200 cursor-pointer flex gap-2 items-center"
            >
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="px-2 bg-white/5 backdrop-blur-md text-gray-300">or sign in with</span>
            </div>
          </div>
