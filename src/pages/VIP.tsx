    ...
    <div className="min-h-screen bg-[#0a0a0a] flex flex-col items-center justify-center p-4 relative">
      ...
      <div className="w-full max-w-md space-y-8 relative">
        ...
        <div className="text-center space-x-4 text-3xl font-mono mb-12">
          <span className="text-white neon-text">LOGIN</span>
        ...
        <div className="grid grid-cols-2 gap-4 mb-8">
          <Button 
            variant="outline" 
            className="bg-transparent border border-purple-500 text-purple-500 hover:bg-purple-500 hover:text-white transition-all duration-300"
        ...
        <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
          ...
          <div className="relative">
            ...
            <button 
              type="button"
              className="absolute right-0 top-1/2 -translate-y-1/2 text-sm text-purple-400 hover:text-purple-300 pr-3"
          ...
          <Button 
            type="submit"
            className="w-full bg-transparent border border-purple-500 text-purple-500 hover:bg-purple-500 hover:text-white transition-all duration-300 mt-8"
          >
            JOIN NOW
          </Button>
        </form>
